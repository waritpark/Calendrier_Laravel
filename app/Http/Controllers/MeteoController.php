...
class MeteoController extends Controller
{
    ...
    public function today()
    {
        ...
        // ->json();
        $meteo = file_get_contents('https://api.openweathermap.org/data/2.5/weather?id=2969562&lang=fr&appid=f4d090607714c839e119246f24a205f1');
    ...
    {
        $meteo = file_get_contents('https://api.openweathermap.org/data/2.5/forecast?id=2969562&lang=fr&appid=f4d090607714c839e119246f24a205f1');
        $meteo = json_decode($meteo, true);
        // dd($meteo);
        return view('meteo', ['meteo'=>$meteo]);
    }
